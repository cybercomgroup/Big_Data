...
X = np.nan_to_num(X)
y = np.nan_to_num(y)
print("Any NANS(X): "+str(np.any(np.isnan(X))))
print("Any Finite(X): "+str(np.any(np.isfinite(X))))
print("Any NANS(y): "+str(np.any(np.isnan(y))))
print("Any Finite(y): "+str(np.any(np.isfinite(y))))

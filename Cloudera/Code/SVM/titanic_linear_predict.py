...
joinedDF.to_csv("linear_prediction.csv",index=False)

coeficientDF=pd.DataFrame(machine.coef_, np.arange(len(machine.coef_)),columns=["Pclass","Sex","Age","SibSp","Parch","Fare","Embarked"])
